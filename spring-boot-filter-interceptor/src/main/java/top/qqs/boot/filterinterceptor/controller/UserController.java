package top.qqs.boot.filterinterceptor.controller;

import jakarta.servlet.http.HttpServletRequest;
import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.web.bind.annotation.*;
import top.qqs.boot.filterinterceptor.annotation.RequireRole;
import top.qqs.boot.filterinterceptor.dto.LoginRequest;
import top.qqs.boot.filterinterceptor.dto.LoginResponse;
import top.qqs.boot.filterinterceptor.entity.User;
import top.qqs.boot.filterinterceptor.result.Result;
import top.qqs.boot.filterinterceptor.service.UserService;
import top.qqs.boot.filterinterceptor.utils.JwtUtil;
