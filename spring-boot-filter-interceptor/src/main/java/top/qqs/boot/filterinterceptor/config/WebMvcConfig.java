package top.qqs.boot.filterinterceptor.config;

import lombok.AllArgsConstructor;
import org.springframework.context.annotation.Configuration;
import org.springframework.web.servlet.config.annotation.InterceptorRegistry;
import org.springframework.web.servlet.config.annotation.WebMvcConfigurer;
import top.qqs.boot.filterinterceptor.interceptor.BusinessLogInterceptor;
import top.qqs.boot.filterinterceptor.interceptor.ParamValidateInterceptor;
import top.qqs.boot.filterinterceptor.interceptor.RoleAuthInterceptor;
import top.qqs.boot.filterinterceptor.interceptor.TimeStatInterceptor;
